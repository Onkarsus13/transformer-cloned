...
# output = cross_attn_maps[-1]
cross_attn_maps.clear()

# dog_image = Image.open('flux-schnell.png').convert("RGB")
...
# if len(cross_attn_maps) > 0:
    ...
    # overlay = cv2.addWeighted(img_np, 0.8, attn_color, 0.5, 0)
